...
function Greenhouse({ viewMode }) {
  ...
  useEffect(() => {
    ...
    if (viewMode === 'focus') {
      ...
      timer = setTimeout(() => setShowFrontWall(false), 0);
    }
...
function Sidebar({ visible, plant, onClose, apiState, currentSensorId, onUpdateSensorId }) {
  ...
  useEffect(() => {
    ...
    if (currentSensorId !== undefined && sensorIdInput !== currentSensorId) {
        ...
        <>
          ...
          <div className="data-group">
            ...
            <div className="tips-box" style={{ borderLeftColor: apiState.health?.color || '#2e8b57' }}>
              ...
              <p style={{ marginTop: '8px', opacity: 0.9, lineHeight: '1.4', fontSize: '0.9rem' }}>
                {apiState.health?.tip || (apiState.health?.id === 'NORMAL'
              ...
              <div className="tip-alert" style={{ color: apiState.health?.color || '#2e8b57' }}>
                ! Protocol: {apiState.health?.id === 'NORMAL' ? 'MONITORING' : 'INTERVENTION REQUIRED'}
              </div>
            </div>
          </div>
          ...
          <div className="data-group">
            ...
            <input className="input-field" placeholder="Species Name" value={plant.name} readOnly style={{ opacity: 0.7 }} />
            <input
